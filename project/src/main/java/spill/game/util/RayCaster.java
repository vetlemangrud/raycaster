...
public class RayCaster {
    ...
    public static Vector hitWall(Vector origin, Vector direction, Level level){
        ...
        if (direction.getAngle() == 0 || direction.getAngle() == 180) {
            ...
            deltaHorizontal = new Vector(deltaY * Math.atan(direction.getAngle()), deltaY);
            closestHorizontal = new Vector(closestY * Math.atan(direction.getAngle()) + origin.getX(), closestY);
        }
